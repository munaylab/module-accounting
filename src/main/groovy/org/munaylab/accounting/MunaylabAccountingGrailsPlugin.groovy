...
class MunaylabAccountingGrailsPlugin extends Plugin {
    ...
    def title = "Accounting Module" // Headline display name of the plugin
    def author = "Munaylab Team"
    def authorEmail = "team@munaylab.org"
    def description = '''\
Munaylab Accounting Module
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/munaylab-financy"
